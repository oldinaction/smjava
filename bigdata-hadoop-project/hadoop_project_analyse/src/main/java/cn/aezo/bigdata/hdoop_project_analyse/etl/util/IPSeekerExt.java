package cn.aezo.bigdata.hdoop_project_analyse.etl.util;

import cn.aezo.bigdata.hdoop_project_analyse.common.GlobalConstants;
import cn.aezo.bigdata.hdoop_project_analyse.etl.util.ip.IPSeeker;
...
public class IPSeekerExt extends IPSeeker {
	...
	public static void main(String[] args) {
		IPSeekerExt seekerExt = new IPSeekerExt();
		System.out.println("192.168.1.1 = " + seekerExt.analyticIp("192.168.1.1"));
		System.out.println("114.55.106.130 = " + seekerExt.analyticIp("114.55.106.130"));
		System.out.println("222.73.235.209 = " + seekerExt.analyticIp("222.73.235.209"));
	}
}
