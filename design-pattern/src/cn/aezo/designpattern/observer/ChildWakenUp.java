package cn.aezo.designpattern.observer;
...
class PropertyMgr {
	...
	static {
		try {
			props.load(ChildWakenUp.class.getClassLoader().getResourceAsStream("cn/aezo/designpattern/observer/observer.properties"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
