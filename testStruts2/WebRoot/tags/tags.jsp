...
<html>
  ...
  <body>
	...
	1、property取action变量值：<s:property value="username" /><br />
	...
	5.1、从StackContext的request中取adminName：<s:property value="#adminName" /> | <s:property value="adminName" /><br />
	5.2、从StackContext中取adminName值：<s:property value="#request.adminName" /><br />
	...
	<hr>
	8、include导入外部文件：(1)<s:include value="include.html"/>(2)<s:include value="'include.html'"/><br />
