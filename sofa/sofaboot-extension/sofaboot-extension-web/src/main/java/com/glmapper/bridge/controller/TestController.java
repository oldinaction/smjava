...
public class TestController {
    ...
    public String annotationImplService() throws IOException {
        // 基础类型扩展
        System.out.println(extension.say()); // newValue
        // 自定义类型接口
        System.out.println(extension.getSimpleSpringBean().test("web")); // extension value: web
        datasourceExtension.getDatasourceBean().getDatasource(); // oracle datasource
